...
#
# The problem is that the verify_password method has no access to outer scope local variables as written. We could change the method definition to include one method parameter to pass in the password.

...
txt = File.read('frankenstein.txt')

sentences = txt.split(/[!\?\.]/)
word_counts = sentences.map { |sentence| sentence.split.size }
longest_sentence_idx = word_counts.index(word_counts.max)


puts sentences[longest_sentence_idx]
puts "The longest sentence has #{word_counts.max} words."

...
# As the code was originally written, the ternary operator on the last line of the method was using variable assignment as its condition, whereas what we needed to do was check equality.  
